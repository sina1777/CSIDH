...
The verification environment for this project utilizes a C-language reference model. This model is a modified version of the original public-domain reference implementation from the official [CSIDH website](https://csidh.isogeny.org/). Our modifications were made for the specific purpose of creating a constant-time golden model to serve as a secure and verifiable reference for our hardware testbenches. The original, unmodified software and its license can be found on the official CSIDH website. We are deeply grateful to the original CSIDH authors for making their work publicly available.
