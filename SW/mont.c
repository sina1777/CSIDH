...
void xISOG(proj *A, proj *P, proj *K, uint64_t l, bool want_multiple)
{
    ...
    for (uint64_t i = 1; i < l / 2; ++i) {
		...
		printf("start of montisog_eval_consume   ");
		printf("QQ.x -->:   ");
		uint_print(&Q.x);
		printf("\n");
		printf("QQ.z -->:   ");
		uint_print(&Q.z);
		printf("\n");
		printf("finish of montisog_eval_consume   ");
		printf("\n"); */
		///////////////////////////////////////////////////
		/* printf("start of edwisog_curve_consume   ");
		printf("\n");
		printf("M[i].x --> :");
		uint_print(&M[i%3].x);
		printf("\n");
		...
		uint_print(&prod.z);
		printf("\n");
		printf("finish of edwisog_curve_consume   ");
		printf("\n"); */
    ...
    if (want_multiple) {
        ...
        xADD(K, &M[l/2%3], &M[(l/2-1)%3], &Ktemp);
		
    }

	
    montisog_eval_finish(P, &Q);
	/* printf("finish of montisog_eval_finish of P   ");
	printf("P.x -->:   ");
	uint_print(&P->x);
	printf("\n");
	printf("P.z -->:   ");
